...
#
# Generated by Vivado on Wed Sep 13 17:29:02 +0800 2017
# IP Build 1846188 on Fri Apr 14 20:52:08 MDT 2017 
#
# usage: Ex_Fifo.sh [-help]
# usage: Ex_Fifo.sh [-lib_map_path]
# usage: Ex_Fifo.sh [-noclean_files]
# usage: Ex_Fifo.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "Ex_Fifo.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Ex_Fifo xil_defaultlib.Ex_Fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Ex_Fifo -key {Behavioral:sim_1:Functional:Ex_Fifo} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Ex_Fifo.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Ex_Fifo.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./Ex_Fifo.sh -help\" for more information)\n"
    exit 1
  fi
