...
#
# Generated by Vivado on Fri Sep 15 11:53:08 +0800 2017
# IP Build 1846188 on Fri Apr 14 20:52:08 MDT 2017 
#
# usage: Fifo_Auto_TA.sh [-help]
# usage: Fifo_Auto_TA.sh [-lib_map_path]
# usage: Fifo_Auto_TA.sh [-noclean_files]
# usage: Fifo_Auto_TA.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "Fifo_Auto_TA.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Fifo_Auto_TA xil_defaultlib.Fifo_Auto_TA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Fifo_Auto_TA -key {Behavioral:sim_1:Functional:Fifo_Auto_TA} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Fifo_Auto_TA.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Fifo_Auto_TA.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./Fifo_Auto_TA.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: Fifo_Auto_TA.sh [-help]\n\
Usage: Fifo_Auto_TA.sh [-lib_map_path]\n\
Usage: Fifo_Auto_TA.sh [-reset_run]\n\
Usage: Fifo_Auto_TA.sh [-noclean_files]\n\n\
