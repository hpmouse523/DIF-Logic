...
HD_PWD='E:/Work_File/CEPC/Logic/DIF-Logic/ECAL_DIF/ECAL_DIF.runs/Fifo_Auto_TA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fifo_Auto_TA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fifo_Auto_TA.tcl
