...
HD_PWD='E:/Work_File/CEPC/Logic/DIF-Logic/DIF-LogicOK °æ±¾/ECAL_DIF/ECAL_DIF.runs/ODDR_Clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ODDR_Clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ODDR_Clk.tcl
